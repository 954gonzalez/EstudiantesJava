...
public class Procesos {
	...
	private void menoredad() {
		...
		for(int i=0;i<edades.length;i++) {
			if(edades[i]< menorEdad) {
			   ...
			   System.out.println("El estudiante con la edad menor es: ");
			for(int j=0;j<edades.length;j++) {
				if(edades[j] == menorEdad) {
					System.out.println("Estudiante : " + (j+1)+" con la edad de: "+ menorEdad);
				}
			}
	...
	private void mayoresDeEdad() {
		...
		System.out.println("los estudiantes mayores o igual a 18 son "+ ma);
	}
